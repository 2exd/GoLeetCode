...
// 当 index 不小于 0 时迭代器可前移
// 当 index 小于 data 的长度时可后移
...
type Iteratorer interface {
	...
	Get(idx int) (I *Iterator) // 将该迭代器设为位于第 idx 节点并返回该迭代器
...
// @return    	i        	*Iterator		新建的 Iterator 迭代器指针
...
// Begin
// @description
//		以 Iterator 迭代器指针做接收者
//		如果迭代器为空，直接结束
//		如果该迭代器元素集合为空，则将下标设为 -1
//		如果该迭代器元素集合不为空，则将下标设为 0
//		随后返回新迭代器指针
